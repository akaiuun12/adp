...
# %% 3개의 분류기(Logistic Regression, DT, kNN)를 훈련하고 평가하기
...
# %% 3개의 분류기를 Majority Voting을 사용하여 연결하기
...
for idx, clf, tt in zip(product([0, 1], [0, 1]), all_clf, clf_labels):
    ...
    axarr[idx[0], idx[1]].scatter(X_train_std[y_train == 1, 0], X_train_std[y_train == 1, 1], c='green', marker='o')
